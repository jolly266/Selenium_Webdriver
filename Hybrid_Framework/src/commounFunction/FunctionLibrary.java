...
public class FunctionLibrary extends AppUtil{
	...
	//method for Role creation
		...
		new Select(driver.findElement(By.xpath(conpro.getProperty("ObjRoleType")))).selectByVisibleText(RoleType);
		...
		{
			Reporter.log("New Role Creation Fail",true);
			return false;
		}	
	}
